 ...
 <div class="container-fluid bgsSection1 ">
          ...
          <section class="container mt-1">
            <div class="row">
              ...
              <div class="col-sm-6 justify-content-center ">
                <img class="celular animate__animated animate__bounce animate__delay-1s animate__fadeInRightBig" src="/wp-content/themes/peibo-child/assets/img/home/01_iPhone_12_Mockup.png" alt="Peibo" /></div>
              </div>
            </div>
          </section>
          <section class="container-fluid d-flex justify-content-center preSection animate__animated animate__bounce animate__delay-3s animate__bounceInUp">
            <div class="row mt-4 container section2">
              <div class="col-sm-12">
                <div class="row">
                  <div class="col-sm-6  columnSection2">
                    <div class="row">
                      <div class="col-sm-3">
                        <img class="iconSection animate__animated animate__bounce animate__delay-4s animate__p" src="/wp-content/themes/peibo-child/assets/img/icons/icon-dinero.png" alt="Peibo" />
                      </div>
                      <div class="col-sm-9">
                        <ul>
                          <li>
                  ...
                  <div class="col-sm-6 columnSection2">
                    <div class="row">
                      <div class="col-sm-3">
                          <img class="iconSection" src="/wp-content/themes/peibo-child/assets/img/icons/icon-mov.png" alt="Peibo" />
                        </div>
                        <div class="col-sm-9">
                          <ul>
                            <li>
...
<section  class="container-fluid pt-4 mb-0 ">
     <!-- Control the column width, and how they should appear on different devices -->
     <div class="row">
